...
docker run --name ${CONTAINER_NAME} -t -v "${REPO_DIR}":/example-starter-plugin:ro cytopia/yamllint -s -c /example-starter-plugin/.yamllintconfig.yaml /example-starter-plugin
